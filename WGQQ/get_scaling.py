...
subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'ptg', '-t'])
subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'ptg_ajet', '-t'])
...
for i in range(n_phi_bins):
    subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'ptg_phi_{}'.format(i), '-t'])
    subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'mwp_phi_{}'.format(i), '-t'])
    subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'ptg_phi_{}_ajet'.format(i), '-t'])
    subprocess.check_call(['python', 'makePlot.py', 'inclusive', 'mwp_phi_{}_ajet'.format(i), '-t'])
